...
function pickKnownParams(args, unknownNames) {
    ...
    logger_1.default.info(`The following arguments are not known and will be ignored: ${unknownNames}`);
    ...
    const asyncHandler = async (req, res) => {
        ...
        try {
            ...
            if (spec.deprecated && spec.command && !exports.deprecatedCommandsLogged.has(spec.command)) {
                ...
                getLogger(driver, req.params.sessionId).warn(`The ${method} ${path} endpoint has been deprecated and will be removed in a future ` +
