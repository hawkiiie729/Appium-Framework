 ...
 */
export function parseCapsForInnerDriver<C extends Constraints>(w3cCapabilities: W3CCapabilities<C>, constraints?: C, defaultCapabilities?: NSCapabilities<C>): ParsedDriverCaps<C> | InvalidCaps<C>;
/**
